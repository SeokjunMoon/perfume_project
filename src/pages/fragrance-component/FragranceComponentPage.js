...
const FragranceComponentPage = () => {
    ...
    */
    ...
    const FragrancesList = [ //top, middle, base 순서
        ...
        [10,"주니퍼베리","신선한 솔잎 향","주니퍼베리는 프루티, 우드 계열입니다. 솔잎과 같이 가별고 날카로우며 신선한 나무 향이 납니다.\n상쾌한 우디향에 쓴 맛과 단 맛도 조화롭게 섞여 신선한 나무 냄새와 같은 솔향을 가집니다. 우드 계열과 잘 어울리는 편입니다.","구찌 - 아쿠아 디 피오리, 조말론 - 우드 세이지 앤 씨 솔트","Fruity"  ],
        ...
        [17,"카다멈","상쾌하고 자극적인 매운 향, 독특한 허브 향","카다멈은 허벌, 스파이시 계열입니다. 청량감이 있는 허브이기 때문에 상쾌한 매운 느낌의 향입니다. 생강 계열의 향신료로 \n쓰이며 특유의 풍부함을 가지고 있습니다. 이를 중화시키기 위한 수단으로 머스크 계열과 우디 계열이 같이 사용되는 경우가 많습니다.","입생로랑 - 몽 파리, 로이비 - 만다린 앤 샌달우드","Spicy"  ],
